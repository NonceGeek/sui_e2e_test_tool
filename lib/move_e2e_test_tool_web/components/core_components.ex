defmodule MoveE2eTestToolWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MoveE2eTestToolWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MoveE2eTestToolWeb.Gettext, "errors", msg, opts)
    end
  end
