...
yystate(28, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 68 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(28, [C|Ics], Line, Tlen, _, _) when C >= 70 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 70 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 72 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 31 ->
    yystate(27, Ics, Line, Tlen+1, 3, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 36, C =< 75 ->
    yystate(27, Ics, Line, Tlen+1, 3, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 77, C =< 114 ->
    yystate(27, Ics, Line, Tlen+1, 3, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 116 ->
    yystate(27, Ics, Line, Tlen+1, 3, Tlen);
yystate(25, Ics, Line, Tlen, _, _) ->
    {3,Tlen,Ics,Line,25};
yystate(24, [66|Ics], Line, Tlen, _, _) ->
    yystate(20, Ics, Line, Tlen+1, 5, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 65 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 67 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(23, [10|Ics], Line, Tlen, _, _) ->
    yystate(23, Ics, Line+1, Tlen+1, 3, Tlen);
...
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 78 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 80 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 116 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 84 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 86 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 3, Tlen);
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 14 ->
    yystate(27, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 104 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 106 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 70 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 72 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 31 ->
    yystate(27, Ics, Line, Tlen+1, 3, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 36, C =< 75 ->
    yystate(27, Ics, Line, Tlen+1, 3, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 77, C =< 114 ->
    yystate(27, Ics, Line, Tlen+1, 3, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 116 ->
    yystate(27, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 115 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 117 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 98 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 100 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 67 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 69 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 3, Tlen);
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 14 ->
    yystate(27, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 109 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 111 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 107 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 109 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 60 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 100 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 102 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(1, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(1, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 104 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
...
-file("src/sui_leex.xrl", 13).
yyaction_0(TokenChars, TokenLine) ->
     { token, { comment, TokenLine, parse_comment (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/sui_leex.xrl", 14).
yyaction_1(TokenChars, TokenLine) ->
     { token, { debug, TokenLine, parse_debug (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("src/sui_leex.xrl", 15).
yyaction_2(TokenChars, TokenLine) ->
     { token, { sui, TokenLine, parse_sui (TokenChars) } } .

-compile({inline,yyaction_3/0}).
-file("src/sui_leex.xrl", 16).
yyaction_3() ->
     skip_token .

-compile({inline,yyaction_4/0}).
-file("src/sui_leex.xrl", 18).
yyaction_4() ->
     skip_token .

-compile({inline,yyaction_5/2}).
-file("src/sui_leex.xrl", 19).
yyaction_5(TokenChars, TokenLine) ->
     { token, { code, TokenLine, parse_code (TokenChars) } } .
